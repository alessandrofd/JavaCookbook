...
public abstract class  ContLineReader extends LineNumberReader {
    ...
    public void setContinuationMode(boolean b) { doContinue = b; }

    /** Get the continuation mode */
    public boolean getContinuationMode() { return doContinue; }

    /** Read one (possibly continued line), stripping the \ that
    ...
    */
     ...
     * call a "super.readLine()" which isn't very practical
     */
    public String readPhysicalLine() throws IOException { return super.readLine(); }

    // Can NOT override getLineNumber is this class to return the #
    ...
    public ContLineReader(Reader in) { super(in); }

    /** Construct a ContLineReader using the given input buffer size */
    public ContLineReader(Reader in, int sz) { super(in, sz); }
    ...
    public int read(char[] cbuf, int off, int len) throws IOException{ return super.read(cbuf, off, len); }
