 ...
 * since any of the print() or println() methods must go through these.</P>
 * Note: there is another way of doing this, using a FilterStream;
 * see the example at http://www.javaspecialist.eu/archive/Issue003.html
 */
public class TeePrintStream extends PrintStream {
    /** The original/direct print stream */
    protected PrintStream parent;

    /** The filename we are tee-ing to */
    ...
    /** Construct a TeePrintStream given an existing PrintStream and as opened OutputStream */
    ...
    public TeePrintStream(PrintStream orig, String fn) throws IOException {
        this(orig, fn, true);
    }

    /** Construct a TeePrintStream given an existing Stream, a filename, and a boolean to control the flush operation. */
