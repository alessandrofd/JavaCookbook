...
public class Camera {
    ...
    public Camera(CameraMake make, String model, CameraType type,
                  int yearIntroduced, double price,
                  double mPix, CameraSensor sensorsize) {
        this.make = make;
        this.model = model;
        this.type = type;
    ...
    // Convenience
    public boolean isIlc() { return type != null && type == CameraType.ILC; }
    public boolean isDslr() { return type != null && type == CameraType.DSLR; }
    public boolean isPointAndShoot() { return type != null && type == CameraType.P_S; }
