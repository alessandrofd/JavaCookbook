...
public class BigNumCalc {
    ...
    /** Calculate a set of operands; the input is as Object array containing either BigDecimal objects (which may be
     * pushed onto the Stack) and operators (which are operated on immediately).
     */
