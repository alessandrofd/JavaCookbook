...
public class PSFormatter {
    ...
    protected static final int INCH = 72; // PS constant: 72 pts/inch
    ...
    protected void doLine(String line) {
        ...
        String l = line.trim(); // removes spaces AND tab
        if(l.length() == 0) {
            ++lineNum;
            return;
        }
