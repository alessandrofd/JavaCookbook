...
public class BookRank {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // Now try to draw a graph, using external
        // plotting program against all historical data.
        // Could use gnuplot, R, or any other math/graph program.
        ...
        gp.println(gnuplot_cmd);
        gp.close();

    }

    /**
     * Look for something like this is the HTML input:
     *    <b>Sales Rank:</b>
     *    #26,252
     *    </font><br>
     */
    ...
    public static int getBookRank(String isbn) throws IOException {
        ...
        // The URL -- must have "isbn=" at the very end, or otherwisee
